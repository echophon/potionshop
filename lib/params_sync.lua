...
-- (run, rate, quantize, prob, alt trig, op1/2/3/4 ratio trig, reset, channel
-- level + per-op levels, clear/copy/paste + action triggers) and, per sequence
...
function M:add_globals()
  ...
  -- per-op output levels are per-channel static scalars (chN_level1..4); all four op
  -- ratios are sequenced, added in the channel groups below.
end
